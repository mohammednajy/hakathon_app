...
class _PostScreenState extends State<PostScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: context.watch<PostProvider>().posts.isEmpty ||
                  ...
                  Expanded(
                    child: Consumer<PostProvider>(
                      builder: (context, providerValue, child) =>
                        ...
                        itemBuilder: (context, index) => Card(
                            ...
                            child: Padding(
                              ...
                              child: ListTile(
                                leading: CircleAvatar(
                                  radius: 25,
                                  backgroundImage: NetworkImage(providerValue
                                              .posts[index].image ==
                                          ""
                                      ? 'https://www.w3schools.com/w3images/avatar2.png'
                                      : providerValue.posts[index].image!),
                                ),
                                title: Padding(
                                  padding: EdgeInsets.only(bottom: 8),
                                  child: Text(
                                    providerValue.posts[index].user.name,
                                    style: TextStyle(
                                ...
                                subtitle: Row(
                                  ...
                                  children: [
                                    Flexible(
                                      flex: 6,
                                      child: Text(
                                        providerValue.posts[index].text,
                                      ),
                                    ),
                                    Flexible(
                                      child: Column(
                        ...
                        itemCount: providerValue.posts.length,
                      ),
                    ),
                  ),
                ],
